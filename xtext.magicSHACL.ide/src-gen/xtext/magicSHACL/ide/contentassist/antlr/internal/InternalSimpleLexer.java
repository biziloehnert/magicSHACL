...
public class InternalSimpleLexer extends Lexer {
    ...
    public final void mRULE_UNICODE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSimple.g:1287:14: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | ':' | '#' | '/' | '.' | '-' | '\"' | '{' | '}' | '\\\\' | '$' )* )
            // InternalSimple.g:1287:16: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | ':' | '#' | '/' | '.' | '-' | '\"' | '{' | '}' | '\\\\' | '$' )*
            {
            // InternalSimple.g:1287:16: ( '^' )?
            int alt1=2;
            ...
            // InternalSimple.g:1287:21: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | ':' | '#' | '/' | '.' | '-' | '\"' | '{' | '}' | '\\\\' | '$' )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSimple.g:1289:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalSimple.g:1289:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalSimple.g:1289:11: ( '^' )?
            int alt3=2;
            ...
            // InternalSimple.g:1289:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSimple.g:1291:10: ( ( '0' .. '9' )+ )
            // InternalSimple.g:1291:12: ( '0' .. '9' )+
            {
            // InternalSimple.g:1291:12: ( '0' .. '9' )+
            int cnt5=0;
            loop5:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSimple.g:1293:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalSimple.g:1293:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalSimple.g:1293:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalSimple.g:1293:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalSimple.g:1293:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
                    ...
                    break;
                case 2 :
                    // InternalSimple.g:1293:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalSimple.g:1293:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSimple.g:1295:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalSimple.g:1295:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalSimple.g:1295:24: ( options {greedy=false; } : . )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSimple.g:1297:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalSimple.g:1297:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalSimple.g:1297:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSimple.g:1299:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalSimple.g:1299:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalSimple.g:1299:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt13=0;
            loop13:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSimple.g:1301:16: ( . )
            // InternalSimple.g:1301:18: .
            {
            matchAny(); 
    ...
    static final String DFA14_eotS =
        "\6\15\3\uffff\1\15\1\uffff\2\15\1\uffff\3\15\1\24\3\uffff\4\15\1\55\2\15\3\uffff\1\60\1\uffff\4\15\3\uffff\1\15\1\uffff\1\64\1\65\1\66\1\uffff\1\67\1\15\1\uffff\2\15\5\uffff\1\15\1\73\2\uffff";
    static final String DFA14_eofS =
        "\74\uffff";
    static final String DFA14_minS =
        "\1\0\5\60\3\uffff\1\55\1\uffff\1\101\1\60\1\uffff\1\60\1\0\1\52\1\0\3\uffff\4\60\1\42\2\60\3\uffff\1\42\1\uffff\2\60\2\0\3\uffff\1\0\1\uffff\3\42\1\uffff\1\42\1\60\1\uffff\2\0\5\uffff\1\40\1\136\2\uffff";
    static final String DFA14_maxS =
