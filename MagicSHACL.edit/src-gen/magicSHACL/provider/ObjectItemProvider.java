...
public class ObjectItemProvider extends NodeItemProvider {
	...
	protected void addXsdTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Object_xsdType_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Object_xsdType_feature",
								"_UI_Object_type"),
						MagicSHACLPackage.Literals.OBJECT__XSD_TYPE, true, false, false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(magicSHACL.Object.class)) {
